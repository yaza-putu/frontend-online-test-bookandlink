export default function QueueMonitor(props) {
    return (
        <>
            <div className={`${props.className} relative overflow-x-auto shadow-md sm:rounded-lg`}>
                <div className="flex items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 pb-4 bg-white">
                    ...
                    <label htmlFor="table-search" className="sr-only mt-2">Search</label>
                    <div className="relative">
                        ...
                        <input type="text" id="table-search-users" className="block p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700" placeholder="Search for users" />
                    </div>
                </div>
